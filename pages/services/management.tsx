  ...
  return (
    <main className={styles.container}>
      ...
      <p className="text-gray-600 text-justify">
        ...
        Immobilie und ein kritisches Hinterfragen der Wohn- und Geschäftsflächen
        wichtig für ein ertragsreiches cash flow. Wir schauen uns jede
        Liegenschaft individuell an und besprechen mit Ihnen die optimale
        Nutzung und eine gute Strukturierung Ihrer Mieterschaft. Alte
